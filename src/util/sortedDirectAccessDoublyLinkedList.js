...
SortedDirectAccessDoublyLinkedList.prototype.valueAccessor = function valueAccessor(_) {
...
SortedDirectAccessDoublyLinkedList.prototype.idAccessor = function idAccessor(_) {
...
SortedDirectAccessDoublyLinkedList.prototype.min = function min() {
  return this._min;
};
...
SortedDirectAccessDoublyLinkedList.prototype.add = function add(datum){
...
SortedDirectAccessDoublyLinkedList.prototype.addMany = function addMany(data) {
  ...
  if (this.size === 1) { // special case: last item to remove
    ...
    if (dln === this._closestTo0) {
      if (this._closestTo0.next === null) {
        ...
        const prevAbsValue = Math.abs(this._closestTo0.prev.value);
        const nextAbsValue = Math.abs(this._closestTo0.next.value);
