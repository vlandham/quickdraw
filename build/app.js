...
/***/ (function(module, exports, __webpack_require__) {
	...
	d3.queue().defer(d3.json, 'data/dog_cat_horse_out.json').defer(d3.json, 'data/circle_bird_swan_flamingo_out.json').defer(d3.json, 'data/ant_mosquito_butterfly_scorpion_out.json').defer(d3.json, 'data/circle_triangle_square_squiggle_out.json').await(display);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createHist() {
	  ...
	  function setupBackground(bKeys) {
	    ...
	    }).attr('height', height).on('mouseover', mouseover.bind(this)).on('mouseout', mouseout.bind(this));
	  }
